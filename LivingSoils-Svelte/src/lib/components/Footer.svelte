		...
		<div class="footer-grid">
			...
			<div class="footer-section">
				...
				<div class="footer-social-icons">
					<a href="https://www.facebook.com/LivingSoils" class="social-icon" aria-label="Facebook">
					...
					<a
						href="https://www.instagram.com/LivingSoils"
						class="social-icon"
					...
					<a
						href="https://www.linkedin.com/company/the-living-soil/"
						class="social-icon"
						aria-label="LinkedIn"
					>
						<svg class="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
		...
		<div class="footer-bottom">
			<div class="footer-bottom-left">
				<div class="flex items-center gap-3 mb-2">
					<img src="/ressources/logoLivingSoils.jpg" alt="LivingSoils" class="footer-logo-small" />
